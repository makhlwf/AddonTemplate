...
> 
> - To contribute or refine translations, please visit our **[Crowdin Project Page](https://crowdin.com)**.
> - If this PR is an automated Crowdin synchronization PR or an authorized maintainer update, please complete the fields below.
...
- [ ] `scons mo` compiles all `.po` files into binary `.mo` files without gettext errors.
- [ ] Manifest localization files build cleanly (`manifest-translated.ini`).
- [ ] No manual formatting or syntax corruption introduced in `.po` headers.
